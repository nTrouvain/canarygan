...
@pytest.mark.parametrize("slice_len", (SliceLengths.SHORT, SliceLengths.MEDIUM, SliceLengths.LONG))
...
@pytest.mark.parametrize("z", (np.random.uniform(-1, 1, (10, 3)), np.random.uniform(-1, 1, (10, 1, 3))))
