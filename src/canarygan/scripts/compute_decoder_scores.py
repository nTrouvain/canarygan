...
parser = argparse.ArgumentParser(description="Score generator using RNN decoder.")

parser.add_argument("--decoder_ckpt", type=str, help="Decoder model checkpoint.")
parser.add_argument(
...
parser.add_argument("--n_is_split", type=int, default=10)
